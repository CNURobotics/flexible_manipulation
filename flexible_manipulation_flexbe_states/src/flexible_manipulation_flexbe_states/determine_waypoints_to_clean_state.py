...
class DetermineWaypointsToClean(EventState):
    '''
    ...
    def __init__(self):
        ...
        Constructor
        '''
        super(DetermineWaypointsToClean, self).__init__(outcomes=['done'],
                                                             output_keys=['waypoints', 'frame_id'])
    ...
    def execute(self, userdata):
        ...
        pose1 = Pose()
        pose1.position = Point(0.5, -0.5, 0.5)
        pose1.orientation = Quaternion(0, 0, 0, 1)

        pose2 = Pose()
        pose1.position = Point(0.5, 0, 0.5)
        pose1.orientation = Quaternion(0, 0, 0, 1)
        ...
        userdata.waypoints = [pose1, pose2, pose3]

        userdata.frame_id = "world"
